...
4. Open the deployed HTTPS site and allow camera access.

The page loads MediaPipe's hand-landmark model from its official hosted model URL. An internet connection is therefore required when the page starts.
